...
**2.利用香橙派AIpro安装LNMP（宝塔面板）搭建私有的Wordpress系统**
...
把香橙派AIpro连接显示器键盘鼠标和网线，开机风扇声音还挺大，不过进入系统后声音变小
...
network:
  ethernets:
    eth0: # 网卡名称
      ...
      addresses: 
          - 192.168.1.245/24  # 设置的子网IP和子网掩码，192.168.1.245代表IP /24代表掩码255.255.255.0
      routes:
          - to : default 
            via: 192.168.1.1   # 网关
      nameservers:
...
也可以做智能家居：可以用于智能家居设备的控制和管理，等等香橙派AIpro还有很多的玩法，如果你有这样的小玩意你会做什么呢？
